...
function harvestBatch($provider_url, $oai_params, $record_callback, $resumptionToken = null) {
...
function harvest_all($provider_url, $oai_params, $record_callback) {
  $resumptionToken = null;
  do {
    $resumptionToken = harvestBatch($provider_url, $oai_params, $record_callback, $resumptionToken);
